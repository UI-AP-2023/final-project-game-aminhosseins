...
public class LogInMenu {
    ...
    private void setLbl_titleSetting(){
        lbl_title=new Label("LOGIN MENU");
    ...
    private void setBtn_loginSetting(Stage owner){
        ...
        btn_login.setBackground(Background.fill(Color.rgb(30,120,250)));
        btn_login.setPrefWidth(150);
        btn_login.setPrefHeight(40);
        btn_login.setLayoutY(285);
        btn_login.setLayoutX(225);
        ...
        btn_login.addEventHandler(MouseEvent.MOUSE_CLICKED, mouseEvent -> {
            try {
                PlayerManager.loginOperation(txt_name.getText(),txt_password.getText());
                PlayerBaseMenu playerBaseMenu=new PlayerBaseMenu(txt_name.getText());
                stage.close();
                owner.close();
